...
{
       0,     0,     2,     5,    10,    14,    16,    18,    20,    22,
      24,    27,    31,    35,    39,    41,    43,    45
};
static const short yyrhs[] =
{
      17,     0,    16,    17,     0,    18,    20,    16,    19,     0,
      18,    21,    19,     0,     3,     0,     4,     0,     5,     0,
       6,     0,     7,     0,    15,    11,     0,    15,    22,    13,
       0,    15,    22,    14,     0,    15,    22,    15,     0,     8,
       0,     9,     0,    10,     0,    12,     0
};
...
{
       0,    80,    81,    84,   102,   111,   114,   117,   118,   119,
     124,   133,   143,   153,   164,   165,   166,   167
};
#endif
...
{
  "$", "error", "$undefined.", "L_PAREN", "R_PAREN", "OP_AND", "OP_OR", 
  "OP_NOT", "OP_EQU", "OP_GT", "OP_LT", "OP_PRESENT", "OP_APPROX", 
  "VAL_INT", "VAL_BOOL", "OPERAND", "filter_list", "filter", 
  "filter_open", "filter_close", "filter_op", "expression", 
  "exp_operator", 0
};
#endif
...
{
       1,-32768,    10,-32768,    -4,-32768,-32768,-32768,-32768,    -3,
       1,     8,-32768,-32768,-32768,-32768,-32768,     4,    11,-32768,
  -32768,-32768,-32768,-32768,-32768,    20,-32768
};

static const short yypgoto[] =
{
      12,    -2,-32768,     3,-32768,-32768,-32768
};
...
{
       5,     6,     7,     8,     1,    12,    13,    14,    15,    16,
      25,     9,    19,     1,     1,    19,     5,    21,    22,    23,
      26,    24,    18
};

static const short yycheck[] =
{
       2,     5,     6,     7,     3,     8,     9,    10,    11,    12,
       0,    15,     4,     3,     3,     4,    18,    13,    14,    15,
       0,    18,    10
};
...
{      /* presence test binds to single operand */
	       ...
	       lslpAttrList *attr = lslpAllocAttr(yyvsp[-1].filter_string, string_type, "*", (int16)strlen("*") + 1);
	       if(attr != NULL) {
...
{   /* both operands are strings */
	   if(NULL != (yyval.filter_filter = lslpAllocFilter(yyvsp[-1].filter_int))) {
	     lslpAttrList *attr = lslpAllocAttr(yyvsp[-2].filter_string, string_type, yyvsp[0].filter_string, (int16)strlen(yyvsp[0].filter_string) + 1 );
	     if(attr != NULL) {
	       _LSLP_INSERT(attr, &(yyval.filter_filter->attrs));
	     } else { lslpFreeFilter(yyval.filter_filter); yyval.filter_filter = NULL ; }
	   }
